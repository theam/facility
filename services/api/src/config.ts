...
const EnvSchema = z
  .object({
    ...
    OIDC_CLIENT_ID: OptionalNonEmpty,
    OIDC_CLIENT_SECRET: OptionalNonEmpty,
    FACILITY_INSTANCE_ID: OptionalNonEmpty,
    FACILITY_OAUTH_ISSUER: OptionalUrl,
    FACILITY_OAUTH_JWKS: OptionalNonEmpty,
    ...
    GITHUB_CLONE_TOKEN: OptionalNonEmpty,
