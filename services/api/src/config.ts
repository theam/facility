...
const EnvSchema = z
  .object({
    ...
    FACILITY_AWS_CODEBUILD_PROJECT: z.string().trim().optional(),
    FACILITY_AWS_CODEBUILD_CACHE_BASE_LOCATION: z.string().trim().optional(),
    ...
    PACKAGE_REGISTRY_TOKEN: z.string().trim().optional(),
